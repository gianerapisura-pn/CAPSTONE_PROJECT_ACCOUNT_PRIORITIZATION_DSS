...
2. Apply `001_initial_schema.sql`, `002_corrective_completion.sql`, then
   `003_current_method_alignment.sql`, `004_four_criterion_final_alignment.sql`, `005_final_hardening.sql`, then `006_final_capstone_alignment.sql`.
